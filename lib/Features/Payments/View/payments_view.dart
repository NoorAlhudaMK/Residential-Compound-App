                      ...
                      child: ChoiceChip(
                        ...
                        onSelected: (selected) {
                          if (selected) {
                            ...
                            context.read<PaymentsBloc>().add(FetchPaymentsEvent(isRefresh: true, status: status));
                          }
                        },
                  ...
                  builder: (context, state) {
                    if (state is PaymentsLoading) {
                      ...
                      return RefreshIndicator(
                        onRefresh: () async {
                          context.read<PaymentsBloc>().add(FetchPaymentsEvent(isRefresh: true, status: _selectedStatus));
                        },
                        child: ListView(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: Icon(
                                        Icons.payments_outlined, // أيقونة مالية
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: Icon(
                                        Icons.account_balance_wallet_outlined, // أيقونة مالية أخرى للطلبات
                                        color: colors.primary,
                                        size: 22,
                                      ),
                                    ),
